...
merged_filtered_markers = pd.read_csv('04_Merge_Curated_Markers/4_harmonized_curated_markers.txt', sep = '\t')
...
merged_filtered_markers = merged_filtered_markers.join(adata.var["feature_length"])
