...
if (!dir.exists("TimeSeriesRetinaCrushImmune")) {
  seu = readRDS('/project/hipaa_ycheng11lab/atlas/CAMR2024/06_Curated_Immune/6_immune.RDS')
...
if (!dir.exists("MouseRetinaAtlas")) {
  print("Mouse Retina Atlas Alone")
  seu = '/project/hipaa_ycheng11lab/atlas/CAMR2024/10_Make_Shiny/10_Shiny_Input.h5ad'
...
seuAtlas = '/project/hipaa_ycheng11lab/atlas/CAMR2024/10_Make_Shiny/10_Shiny_Input.h5ad'
...
seuImmune = readRDS('/project/hipaa_ycheng11lab/atlas/CAMR2024/06_Curated_Immune/6_immune.RDS')
